...
void proc_wall_clock()
{
	...
	while(1)
	{
		...
		if(k_display_clock == 1) // If display flag set, send time to crt
		{
			...
			output_msg->msg_size = sprintf(output_msg->msg_text, "\033[s\033[0;72H\033[K\033[1;31m%02d\033[1;33m:\033[1;31m%02d\033[1;33m:\033[1;31m%02d\033[u", k_clock_h, k_clock_m, k_clock_s); 
